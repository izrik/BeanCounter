...
namespace MetaphysicsIndustries.Giza
{
    public class CsvGrammar : Grammar
    {
        ...
        public DefRefNode node_file_0_record;
        public CharNode node_file_1__000D_;
        public CharNode node_file_2__000A_;
        public DefRefNode node_file_3_record;
        public CharNode node_file_4__000D_;
        public CharNode node_file_5__000A_;
        public DefRefNode node_record_0_field;
        public CharNode node_record_1__002C_;
        public DefRefNode node_record_2_field;
        ...
        public CsvGrammar()
        {
            ...
            node_file_0_record = new DefRefNode(def_record, "record");
            node_file_1__000D_ = new CharNode(CharClass.FromUndelimitedCharClassText("\\r"), "\r");
            node_file_2__000A_ = new CharNode(CharClass.FromUndelimitedCharClassText("\\n"), "\n");
            node_file_3_record = new DefRefNode(def_record, "record");
            node_file_4__000D_ = new CharNode(CharClass.FromUndelimitedCharClassText("\\r"), "\r");
            node_file_5__000A_ = new CharNode(CharClass.FromUndelimitedCharClassText("\\n"), "\n");
            def_file.Nodes.Add(node_file_0_record);
            def_file.Nodes.Add(node_file_1__000D_);
            def_file.Nodes.Add(node_file_2__000A_);
            def_file.Nodes.Add(node_file_3_record);
            def_file.Nodes.Add(node_file_4__000D_);
            def_file.Nodes.Add(node_file_5__000A_);
            def_file.StartNodes.Add(node_file_0_record);
            def_file.EndNodes.Add(node_file_5__000A_);
            def_file.EndNodes.Add(node_file_3_record);
            def_file.EndNodes.Add(node_file_0_record);
            node_file_0_record.NextNodes.Add(node_file_1__000D_);
            node_file_0_record.NextNodes.Add(node_file_2__000A_);
            node_file_0_record.NextNodes.Add(node_file_4__000D_);
            node_file_0_record.NextNodes.Add(node_file_5__000A_);
            node_file_1__000D_.NextNodes.Add(node_file_2__000A_);
            node_file_2__000A_.NextNodes.Add(node_file_1__000D_);
            node_file_2__000A_.NextNodes.Add(node_file_2__000A_);
            node_file_2__000A_.NextNodes.Add(node_file_3_record);
            node_file_3_record.NextNodes.Add(node_file_1__000D_);
            node_file_3_record.NextNodes.Add(node_file_2__000A_);
            node_file_3_record.NextNodes.Add(node_file_4__000D_);
            node_file_3_record.NextNodes.Add(node_file_5__000A_);
            node_file_4__000D_.NextNodes.Add(node_file_5__000A_);
            node_file_5__000A_.NextNodes.Add(node_file_4__000D_);
            node_file_5__000A_.NextNodes.Add(node_file_5__000A_);

            def_record.Directives.Add(DefinitionDirective.MindWhitespace);
            node_record_0_field = new DefRefNode(def_field, "field");
            node_record_1__002C_ = new CharNode(CharClass.FromUndelimitedCharClassText(","), ",");
            node_record_2_field = new DefRefNode(def_field, "field");
            def_record.Nodes.Add(node_record_0_field);
            def_record.Nodes.Add(node_record_1__002C_);
            def_record.Nodes.Add(node_record_2_field);
            def_record.StartNodes.Add(node_record_0_field);
            def_record.EndNodes.Add(node_record_2_field);
            def_record.EndNodes.Add(node_record_1__002C_);
            def_record.EndNodes.Add(node_record_0_field);
            node_record_0_field.NextNodes.Add(node_record_1__002C_);
            node_record_1__002C_.NextNodes.Add(node_record_2_field);
            node_record_1__002C_.NextNodes.Add(node_record_1__002C_);
            node_record_2_field.NextNodes.Add(node_record_1__002C_);
